...
def scene_reconstruction(dataset, opt, hyper, pipe, testing_iterations, saving_iterations, 
    ...
    wandb.init(project="ed3dgs_mead_align", name="dxdo_dense_fifteen", notes="no pruning if n_gaussians less than 10k, net width 64")#, mode="offline")
    ...
    for iteration in range(first_iter, final_iter+1):             
        ...
        with torch.no_grad():
            ...
            if iteration < opt.densify_until_iter :
                ...
                if iteration > opt.pruning_from_iter and iteration % opt.pruning_interval == 0 and gaussians._xyz.shape[0] > 10000:
                    size_threshold = 20 if iteration > opt.opacity_reset_interval else None
