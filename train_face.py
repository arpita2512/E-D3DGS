...
def scene_reconstruction(dataset, opt, hyper, pipe, testing_iterations, saving_iterations, 
    ...
    for iteration in range(first_iter, final_iter+1):             
        ...
        for viewpoint_cam in viewpoint_cams:
            ...
            # for separate inner mouth
            gt_image_white[:, viewpoint_cam.talking_dict['mouth_mask']] = background[:, None]
...
def training(dataset, hyper, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from, expname):
    ...
    timer = Timer()
    scene = Scene(dataset, gaussians, shuffle=dataset.shuffle, loader=dataset.loader, duration=None, opt=opt, ply_name="face_nomouth_downsample.ply")
