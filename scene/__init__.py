...
from utils.camera_utils import camera_to_JSON, cameraList_from_camInfosv2, cameraList_from_camInfosHyper, cameraList_from_camInfos
...
class Scene:
    def __init__(self, args : ModelParams, gaussians, load_iteration=None, shuffle=False, duration=None, loader=None, testonly=None, opt=None, ply_name="points3D_downsample.ply", load_bg=False):
        ...
        if loader == "dynerf":
            ...
            scene_info = sceneLoadTypeCallbacks["ColmapAudio"](args.source_path, args.images, ply_name)
        ...
        #print("in scene init before cam list" )
        ...
        if loader not in ["nerfies", "dynerf", "colmap", "colmapAudio"]:
