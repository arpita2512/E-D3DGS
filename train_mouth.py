...
def scene_reconstruction(dataset, opt, hyper, pipe, testing_iterations, saving_iterations, 
    ...
    for iteration in range(first_iter, final_iter+1):             
        ...
        for viewpoint_cam in viewpoint_cams:
            ...
            gt_image_mouth = gt_image * mouth_mask + background[:, None, None] * ~mouth_mask
            
            gt_image_mouth = gt_image_mouth[:, xmin:xmax, ymin:ymax]
            ...
            gt_images.append(gt_image_mouth.unsqueeze(0))
...
def training(dataset, hyper, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from, expname):
    ...
    gaussians = GaussianModel(dataset.sh_degree, hyper, deform_type="mouth")
    dataset.model_path = args.model_path
    timer = Timer()
    scene = Scene(dataset, gaussians, shuffle=dataset.shuffle, loader=dataset.loader, duration=None, opt=opt, ply_name="may_mouth.ply")
