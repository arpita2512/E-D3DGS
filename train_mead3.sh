...
python train3.py -s "/mnt/scratch/scasag/aligned_input/" --configs "/users/scasag/E-D3DGS/arguments/mead/default3.py" --model_path "/mnt/scratch/scasag/align_op3/" --expname "mead" #-r 2
